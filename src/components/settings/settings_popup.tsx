  ...
  render() {
    ...
    return (
      <div className={styles.SettingsPopup}>
        ...
        />
        <Checkbox
          label={getMessage("setting_popup_summarize_action_icon")}
          checked={settings.showPopupSummarizeIcon}
          onChange={v => settings.showPopupSummarizeIcon = v}
          children={<Icon material={materialIcons.summarize}/>}
        />
        <Checkbox
