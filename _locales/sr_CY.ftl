...
# DeepSeek AI integration (SR_CY)
deepseek_get_own_key_info=Региструјте се на platform.deepseek.com и допуните баланс (нпр. преко PayPal-а)
deepseek_auth_key=Креирајте API приступни кључ на платформи DeepSeek и сачувајте га овде у подешавањима
deepseek_auth_key_warning=Упозорење: НЕ уносите свој API кључ ни на једном другом месту осим у прозору овог додатка
