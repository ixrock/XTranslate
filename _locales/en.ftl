...
use_chrome_tts = Force use chrome text-to-speech engine
use_chrome_tts_tooltip_info = This option is enabled anyway when translator don't have available TTS engine
...
deepl_insert_auth_key = Setup auth-key for DeepL API.
