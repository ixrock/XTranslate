...
settings_title_voice = Голос
settings_title_advanced_providers_list = Продвинутый список переводчиков
settings_title_advanced_providers_list_show = Показать расширенные настройки
settings_title_advanced_providers_list_hide = Скрыть расширенные настройки
...
show_select_provider_icon_in_popup = Отображать иконку выбора провайдера перевода
...
context_menu_translate_full_page_context_menu_stop = Остановить перевод страниц для { $site }
