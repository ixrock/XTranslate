...
show_context_menu = Прикажи ставку у контекстном менију (обавезно за *.pdf)
...
show_close_popup_button = Прикажи иконицу за затварање искачућег прозора у десном ћошку
