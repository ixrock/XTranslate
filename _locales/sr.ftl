...
# header
open_in_window = Отворите у засебном прозору
...
show_context_menu = Прикажи ставку у контекстном менију (овабезно за *.pdf)
display_icon_near_selection = Прикажи иконицу за превод поред изабраног текста
...
show_close_popup_button = Прикажи иконицу за затварање искачућег прозода у десном ћошку
...
box_size_min_width = Минимилна ширина
...
rate_app_info2 = То ће помоћи другим корисницима да пронађу проширење у Chrome веб продавници.
...
favorites_info_tooltip = Да би мењали омиљене језике (листа на врху), користите { $hotkey } + клик
...
mellowtel_text2 = Нова верзија укључује open-source { $link } библиотеку. Ова библиотека вам омогућава да поделите некоришћени интернет са поузданим AI лабораторијама & startup-има који га користе да тренирају своје моделе.
...
mellowtel_regulation1 = Не прикупља, дели нити продаје приватне информације (чак ни анонимне податке).
